                    ...
                    <fieldset>
                        <div class="control-group">
                            ...
                            <div id="tag-container">
                                ...
                                @foreach (json_decode($color->color) as $s)
                                ...
                                <input type="hidden" name="color" id="color-hidden-input"
                                    value="{{ implode(',', json_decode($color->color)) }}"> <!-- Initial Value for Editing -->
                            </div>
                        </div>
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        let tags = @json(json_decode($color->color)); // Initial tags set from the database
